...
namespace NINA.Equipment.Equipment.MyTelescope {
    ...
    internal class IndigoTelescope : IndigoDevice<IINDITelescope>, ITelescope, IDisposable {
        ...
        public IndigoTelescope(INDIDeviceInfo info, IProfileService profileService) : base(info) {
        ...
        protected override IINDITelescope GetInstance() {
            return device ??= new NINA.Indigo.Devices.IndigoTelescope(_device);
        }
