...
namespace NINA.Indigo.Devices {
    ...
    /// <summary>
    /// INDIGO flat-panel/light-box device. Uses IndigoClient for protocol communication.
    /// </summary>
    public class IndigoFlatDevice : INDIFlatDevice {
        public IndigoFlatDevice(INDIDeviceInfo info) : base(info) { }
