...
namespace NINA.Indigo.Devices {
    ...
    /// <summary>
    /// INDIGO auxiliary/switch-hub device. Uses IndigoClient for protocol communication.
    /// </summary>
    public class IndigoSwitchHub : INDISwitchHub {
        public IndigoSwitchHub(INDIDeviceInfo info) : base(info) { }
