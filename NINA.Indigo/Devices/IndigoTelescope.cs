...
namespace NINA.Indigo.Devices {
    ...
    /// <summary>
    /// INDIGO telescope/mount device. Uses IndigoClient for protocol communication.
    /// </summary>
    public class IndigoTelescope : INDITelescope {
        public IndigoTelescope(INDIDeviceInfo info) : base(info) { }
