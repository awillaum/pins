...
namespace NINA.Indigo.Devices {
    ...
    /// <summary>
    /// INDIGO rotator device. Uses IndigoClient for protocol communication.
    /// </summary>
    public class IndigoRotator : INDIRotator {
        public IndigoRotator(INDIDeviceInfo info) : base(info) { }
