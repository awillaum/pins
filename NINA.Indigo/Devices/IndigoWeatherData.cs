...
namespace NINA.Indigo.Devices {
    ...
    /// <summary>
    /// INDIGO weather/environment sensor device. Uses IndigoClient for protocol communication.
    /// </summary>
    public class IndigoWeatherData : INDIWeatherData {
        public IndigoWeatherData(INDIDeviceInfo info) : base(info) { }
