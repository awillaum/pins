...
namespace NINA.Indigo.Devices {
    ...
    /// <summary>
    /// INDIGO focuser device. Uses IndigoClient for protocol communication.
    /// </summary>
    public class IndigoFocuser : INDIFocuser {
        public IndigoFocuser(INDIDeviceInfo info) : base(info) { }
